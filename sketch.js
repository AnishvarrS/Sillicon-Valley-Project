...
function preload(){
  Bouncer_running =   loadAnimation("OVer.jpg", "Run 1.jpg", "Run 2.jpg");
  Bouncer_collided = loadAnimation("OVer.jpg");
...
function setup() {
  ...
  GameOver = createSprite(950,340);
  GameOver.addImage(GameOverImg);
  
  restart = createSprite(950,540);
...
function spawnNinjas() {
  if(frameCount % 60 === 0) {
    ...
    Ninja.y = Math.round(random(600,800));
    //obstacle.debug = true;
